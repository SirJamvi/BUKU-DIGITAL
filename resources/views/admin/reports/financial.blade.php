...
<x-card>
    ...
    <div class="d-flex justify-content-between align-items-center mt-4 mb-3">
        ...
        @if($reportData['cash_flows']->total() > 0)
        <small class="text-muted">
            Menampilkan {{ $reportData['cash_flows']->firstItem() }}–{{ $reportData['cash_flows']->lastItem() }}
            dari {{ $reportData['cash_flows']->total() }} transaksi
        </small>
        @endif
    </div>
    ...
    {{-- ========================================== --}}
    @if($reportData['cash_flows']->hasPages())
    <div class="d-flex justify-content-center mt-2">
        {{ $reportData['cash_flows']->onEachSide(1)->links('pagination::bootstrap-5') }}
    </div>
    @endif
            ...
            <div class="card bg-light">
                <div class="card-body">
                    ...
                    <ul class="list-unstyled mb-0 small">
                        ...
                        <li class="mb-2">
                            <strong>Total Transaksi:</strong> {{ $reportData['cash_flows']->total() }} item
                        </li>
                        <li>
...
@push('styles')
<style>
    /* Perkecil padding card body */
    .card-body {
        padding: 1rem !important;
    }

    /* Kurangi margin bawah breadcrumb */
    .breadcrumb {
    ...
    /* Perkecil pagination dan hilangkan margin bawah */
    .pagination {
